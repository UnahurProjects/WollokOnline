...
/**
 * Panel lateral del enunciado (imagen). Ancho controlado por el contenedor
 * (redimensible desde ExamWorkspace), con zoom (+/−) y scroll. Anti-copia.
 */
export function StatementPanel({
  ...
  return (
    <aside style={{ width }} className="flex shrink-0 flex-col">
      ...
      <div className="min-h-0 flex-1 overflow-auto bg-black/5 p-2 dark:bg-black/30">
